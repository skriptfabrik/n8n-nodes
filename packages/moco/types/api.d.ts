...
export type CustomerCompanyParameters = CommonCompanyParameters & {
  type: 'customer';
  currency: string;
  identifier: string;
  customer_tax?: number;
...
export type SupplierCompanyParameters = CommonCompanyParameters & {
  type: 'supplier';
  iban?: string;
  supplier_tax?: number;
...
export type OrganizationCompanyParameters = CommonCompanyParameters & {
  type: 'organization';
};
