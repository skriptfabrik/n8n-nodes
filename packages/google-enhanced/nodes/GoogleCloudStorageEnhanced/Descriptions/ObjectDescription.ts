...
export const objectOperations: INodeProperties[] = [
  {
    ...
    options: [
          ...
          send: {
            preSend: [
              ...
              async function (this, requestOptions) {
                ...
                const headers = this.getNodeParameter(
                  'encryptionHeaders',
                ) as IDataObject;
              ...
              async function (this, requestOptions) {
                ...
                let metadata: IDataObject = {
                  name: this.getNodeParameter('objectName') as string,
                };
                const bodyData = this.getNodeParameter(
                  'createData',
                ) as IDataObject;
                ...
                if (useBinary) {
                  ...
                  const binaryData =
                    this.helpers.assertBinaryData(binaryPropertyName);
                  if (binaryData.id) {
              ...
              async function (this, requestOptions) {
                ...
                if (!returnAll)
                  requestOptions.qs.maxResults =
                    this.getNodeParameter('maxResults');
              ...
              const extractBucketsList = (page: INodeExecutionData) => {
                ...
                if (objects) {
                  executions = executions.concat(
                    objects.map((object) => ({ json: object })),
                  );
                }
              };
      ...
      },
      {
        ...
        action: 'Update metadata of an object',
      },
    ],
    default: 'getAll',
  },
    ...
    options: [
      {
        ...
        type: 'string',
        placeholder:
          'Returns results in directory-like mode, using this value as the delimiter',
        default: '/',
      },
      {
        ...
        type: 'string',
        placeholder:
          'Filter results to names lexicographically before this value',
        default: '',
      },
      {
      ...
      },
      {
        ...
        type: 'string',
        placeholder:
          'Filter results to names lexicographically equal or after this value',
        default: '',
      },
      {
        ...
        type: 'boolean',
        placeholder:
          'If true, list all versions of objects as distinct entries',
        default: false,
      },
    ],
  },
